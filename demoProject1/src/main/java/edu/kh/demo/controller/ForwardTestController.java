...
// * instance : 개발자가 만든 'new'를 사용해서 만든 객체
// * bean     : Spring (Java)이 만든 객체 

// @Controller 어노테이션
// 1) 'Controller' 임을 명시
// 2) 클래스 작성된 내용대로 구현
// 		-> Spring이 객체 생성 == bean 등록 / 생성

@Controller
public class ForwardTestController {

	// 기존 Servlet
	// - @WebServlet("요청주소") -> 클래스명 위 작성
	 ...
	 * 	 @GetMapping("요청주소") == 'doget'  -> 메서드명 위에만 작성
	 * 	 @PostMapping("요청주소") == 'dopost'-> 메서드명 위에만 작성
	 * 
	...
	// 5) 매핑할 요청 주소를 @RequestMapping 등을 이용해서 작성
