...
//	@RequestMapping(value = "test1", method = RequestMethod.GET)
	...
	public String test4(
		 ...
		 * 값을 작성하지 않은 경우 "(빈칸)"이 제출됨!
		 * 
		 * -> 제출되는 값이 존재하기 때문에
		 * 		@RequestParam()에 아무 속성을 적지 않아도 잘 얻어와짐! 
		 * 
		 ...
		 * 	 --> 만약 제출되지 않을 경우
		 * 			 HTTP 상태 코드 400 -> 400 Bad Request 에러 발생
		 * 
		 ...
		 * 
		 * 
		 * * required = false 일 때, 경우 값이 제출되지 않으면 -> null
		 * 
		 * * defaultValue :
