 ...
 *  
 *  --> (Session)HandShakeInterceptor가
 *       HTTP의 Session을 가로채서 WebSocket에서 사용가능한 형태로 변환
 * 
 * - 어떤 요청 주소가 WebSocket 요청인지 지정코드가 있어야 함
 */
...
if(notificationLoginCheck){ // common.html에 선언된 전역 변수
  ...
  // -> 요청을 처리하는 WebSockHander와 연결
  //    --> WebSockHander에 연결된 회원의 정보를 모아두게 된다!!!
